...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      ...
      {/* Barre latérale */}
      <div className={cn(
        "fixed lg:relative z-30 h-screen w-64 bg-white shadow-sm border-r transition-transform duration-300 ease-in-out transform",
      ...
      {/* Contenu principal */}
      <main className="flex-1 w-full lg:w-[calc(100%-16rem)] lg:ml-64 min-h-screen transition-all duration-300">
