...
const filters = ["Manucure", "Pédicure", "Pose de gel", "Nail art", "French"]

const salons = [
  {
    id: 1,
    name: "Nail Studio Élégance",
    address: "12 Rue de la Paix, 75001 Paris",
    rating: 4.9,
    reviewCount: 178,
    priceRange: "€€€",
    image: "/elegant-nail-salon-manicure-stations.jpg",
    featured: true,
    timeSlots: {
  ...
  },
  {
    ...
    reviewCount: 145,
    priceRange: "€€",
    image: "/modern-nail-salon-professional-setup.jpg",
    featured: true,
    timeSlots: {
  ...
  },
  {
    ...
    reviewCount: 201,
    priceRange: "€€€€",
    image: "/luxury-nail-salon-premium-service.jpg",
    featured: false,
    timeSlots: {
...
export default function ManucureVillePage({ params }: PageProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-2">
            Les meilleurs salons de manucure aux alentours de {cityName} : Réservation en ligne
          </p>
