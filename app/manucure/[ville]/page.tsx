...
export default async function ManucureVillePage({ params }: PageProps) {
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-2">Les meilleurs salons de manucure aux alentours de {city.name} : Réservation en ligne</p>
