...
const filters = ["Coupe", "Coloration", "Balayage", "Brushing", "Soins"]
...
const salons = [
  {
    ...
    reviewCount: 156,
    priceRange: "€€€",
    image: "/modern-hair-salon-interior-styling-chairs.jpg",
    featured: true,
    timeSlots: {
  ...
  },
  {
    ...
    reviewCount: 89,
    priceRange: "€€€€",
    image: "/elegant-hair-salon-modern-interior.jpg",
    featured: true,
    timeSlots: {
  ...
  {
    id: 3,
    name: "Studio Capillaire",
    address: "42 Rue Saint-Antoine, 75004 Paris",
    rating: 4.7,
    reviewCount: 203,
    priceRange: "€€",
    image: "/contemporary-hair-studio-professional.jpg",
    featured: false,
    timeSlots: {
...
export default function CoiffeurVillePage({ params }: PageProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-2">
            Les meilleurs salons de coiffure aux alentours de {cityName} : Réservation en ligne
          </p>
